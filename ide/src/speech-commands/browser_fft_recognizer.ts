...
export class BrowserFftSpeechCommandRecognizer implements
  ...
  readonly MODEL_URL_PREFIX =
    `https://storage.googleapis.com/tfjs-models/tfjs/speech-commands/v${getMajorAndMinorVersion(version)}/browser_fft`;
...
class TransferBrowserFftSpeechCommandRecognizer extends
  ...
  private collectTransferDataAsTensors(
    ...
    augmentationOptions?: AudioDataAugmentationOptions): { xs: tf.Tensor, ys: tf.Tensor } {
